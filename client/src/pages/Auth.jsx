      ...
      <div className='auth-container-2'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label htmlFor="password">
            ...
            <input type="password" name='password' id='password'  onChange={(e) => {setPasssword(e.target.value)}}/>
          ...
          { isSignup && (
            <p style={{color:"#666767", fontSize: "13px"}}>
              ...
              <span style={{color: "#007ac67"}}> terms of<br/> service</span>,
              <span style={{color: "#007ac67"}}> privacy policy</span> and 
              <span style={{color: "#007ac67"}}>cookie policy</span>.
            </p>
          )}
        </form>
        <p>
          {isSignup ? 'Already have an account?' : "Don't have an account?"}
          <button type='button' className='handle-swicth-btn' onClick={handleSwitch}>{ isSignup ? "Log in" : 'Sign up'}</button>
        </p>
      </div>
    </section>
  )
